...
ekfState_pro.featureState  = ekfState.featureState;
ekfState_pro.imuCovar = P*ekfState.imuCovar*P'+Qd;

 % Enforce PSD-ness
ekfState_pro.imuCovar = enforcePSD(ekfState_pro.imuCovar);

ekfState_pro.imuFeatureCovar  = P*ekfState.imuFeatureCovar;
ekfState_pro.featureCovar  = ekfState.featureCovar;
